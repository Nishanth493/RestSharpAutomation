...
Scenario Outline: Verify that market value of funded Account is retrieved periodically based on the provided start and end dates
	...
	Examples: 
	| periodType | Agent  | householdaccountservice                                                             | AplId  |
...
Scenario Outline: Verify that market value of closed Account is retrieved periodically based on the provided start and end dates
	...
	| Monthly    | AG1634 | householdaccountservice_URL,accounts/,AH22M9,/marketvalues,/2013-03-04,/2019-11-18/ | AH22M9 |
	| Quarterly  | AG1634 | householdaccountservice_URL,accounts/,AH22M9,/marketvalues,/2013-03-04,/2019-11-18/ | AH22M9 |
	| Yearly     | AG1634 | householdaccountservice_URL,accounts/,AH22M9,/marketvalues,/2013-03-04,/2019-11-18/ | AH22M9 |
...
Scenario Outline: Verify that  market value of pending Account is displayed as blank periodically when start and end dates are provided
	...
	| Monthly    | AG1634 | householdaccountservice_URL,accounts/,AH6J62,/marketvalues,/2013-03-04,/2019-11-18/ | AH6J62 |
	| Quarterly  | AG1634 | householdaccountservice_URL,accounts/,AH6J62,/marketvalues,/2013-03-04,/2019-11-18/ | AH6J62 |
	| Yearly     | AG1634 | householdaccountservice_URL,accounts/,AH6J62,/marketvalues,/2013-03-04,/2019-11-18/ | AH6J62 |
...
Scenario Outline: Verify that market value of an Account is not retrieved when invalid request is passed
	...
	|            | AG1634 | householdaccountservice_URL,accounts/,AH9U47,/marketvalues,/2015-03-16,/2019-11-18/ |
	| Monthly    | AG1634 | householdaccountservice_URL,accounts/,AH9U47,/marketvalues,/2015-03-16,//           |	
	| Monthly    | AG1634 | householdaccountservice_URL,accounts/,AH9U47,/marketvalues                          |
	| Monthly    | AG1634 | householdaccountservice_URL,accounts/,AH9U47,/marketvalues,/#$@@#$@$                |
